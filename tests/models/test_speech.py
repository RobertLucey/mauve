...
"My dear fellow, I am so sorry.  When I am painting, I can not think of anything else.  But you never sat better.  You were perfectly still.  And I have caught the effect I wanted--the half-parted lips and the bright look in the eyes.  I do not know what Harry has been saying to you, but he has certainly made you have the most wonderful expression.  I suppose he has been paying you compliments.  You must not believe a word that he says."
        ...
        self.assertEquals(
            ...
            [
                ...
                {'text': "My dear fellow , I am so sorry . When I am painting , I can not think of anything else . But you never sat better . You were perfectly calm . And I have caught the put I wanted -- the half-parted lips and the interesting look in the eyes . I do not know what Harry has been saying to you , but he has certainly made you have the most good expression . I suppose he has been paying you compliments . You must not think a word that he says .", 'speaker': {'name': '', 'gender': None}, 'inflection': None}
            ]
        )
...
'''
        ...
        import pprint
        pprint.pprint([s.serialize() for s in speech_parts if s])

        self.assertEqual(
            [s.serialize() for s in speech_parts if s],
            [
                {'text': 'If you did mark it ,', 'speaker': {'name': 'King', 'gender': 'male'}, 'inflection': 'said'},
                {'text': 'that only makes the matter worse . You  must  have meant some mischief , or else you would have signed your name love an right man .', 'speaker': {'name': 'King', 'gender': 'male'}, 'inflection': 'said'}
            ]
        )
